...
import com.LockOriginalMods.refinedforage.init.FunctionalIntReferenceHolder;
...
public class AlloySmelterContainer extends Container {
    ...
    public FunctionalIntReferenceHolder SmeltTime;


    protected AlloySmelterContainer(final int windowId, final PlayerInventory playerInv, final AlloySmelterTileEntity tile) {
        super(RefinedContainerTypes.ALLOY_SMELTER.get(), windowId);
