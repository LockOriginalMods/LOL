...
public class AlloySmelter extends Block {
    ...
    public  AlloySmelter(Properties properties) {
        super(properties);
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return ModTileEntityTypes.ALLOY_SMELTER.get().create();
    }
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, BlockState state, LivingEntity placer, ItemStack stack) {
        ...
        if (stack.hasDisplayName()) {
            ...
            if (tile instanceof AlloySmelterTileEntity) {
                ((AlloySmelterTileEntity) tile).setCustomName(stack.getDisplayName());
            }
        }
    }
    ...
    public void onReplaced(BlockState state, World worldIn, BlockPos pos, BlockState newState, boolean isMoving) {
        TileEntity tile = worldIn.getTileEntity(pos);
        if (tile instanceof AlloySmelterTileEntity && state.getBlock() != newState.getBlock()) {
            AlloySmelterTileEntity furnace = (AlloySmelterTileEntity) tile;
            ((RefinedForageItemHandler) furnace.getInventory()).toNonNullList().forEach(item -> {
